...
def main():
    ...
    output_filename = "capitalization_analysis_output_v0b.csv"
    ...
    diagnostic_filename = "diagnostic_statistics_v0b.csv"
    ...
    if chart_selection['should_generate_chart']:
        ...
        chart_filename = f"rnd_to_btd_vs_earnings_surprise_v0b.png"
