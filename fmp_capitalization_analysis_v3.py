...
def main():
    ...
    # Default: use all US public companies
    all_companies_df = fetch_all_us_companies(API_KEY)
    tickers = all_companies_df['symbol'].tolist()
    ...
    tech_tickers = all_companies_df[all_companies_df['sector'].str.lower().str.contains('tech')]['symbol'].tolist()
    ...
    plot_regression_chart(
        ...
        x_col='cap_intensity',
        y_col='ocf_margin_next',
        chart_filename='cap_intensity_vs_ocf_margin_v3.png',
        title='Next Period OCF Margin to Capitalization Intensity — Top Statistically Significant Outliers',
        subtitle=None,  # Subtitle handled in plot_regression_chart
        date_range_str=date_range_str,
        market_df=sp500_full_df_cap,
        market_tech_df=sp500_tech_full_df_cap
    )
    print("[DIAGNOSTIC] cap_intensity_vs_ocf_margin_v3.png exported.")
    ...
    plot_regression_chart(
        ...
        subtitle=None,  # Subtitle handled in plot_regression_chart
        date_range_str=date_range_str,
        market_df=sp500_full_df_rnd,
        market_tech_df=sp500_tech_full_df_rnd
    )
    print("[DIAGNOSTIC] rnd_deferral_vs_ocf_margin_v3.png exported.")
    # ... existing code ...
