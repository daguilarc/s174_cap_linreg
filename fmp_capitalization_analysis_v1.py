...
def main():
    ...
    plot_regression_chart(
        ...
        chart_filename='rnd_deferral_vs_ocf_margin_v1.png',
    ...
    print("[DIAGNOSTIC] rnd_deferral_vs_ocf_margin_v1.png exported.")
