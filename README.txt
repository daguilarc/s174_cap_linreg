...
- Includes 18 control variables with rolling 4-quarter calculations
- Includes lagged OCF margin control variable
- Generates both cap_intensity and R&D deferral ratio charts
...
- Baseline sector: Dynamically determined from data (most common sector)
- References to "S&P 500" replaced with "Market" in charts and output
- cap_intensity is a control variable (not a treatment variable)
- Includes 18 control variables with rolling 4-quarter calculations
- Enhanced data collection for broader company universe
- Removed lagged OCF margin control variable
- Only generates R&D deferral ratio chart (cap_intensity chart removed)
- Tech Industry Trend Line added to charts (purple dotted line)
- Y-axis labels updated to show "4Q" instead of "Rolling Average"
...
8. **Dynamic Sector Baseline**: Reference sector now determined dynamically from actual data
9. **Removed Lagged OCF Control**: Eliminated ocf_margin_lagged from control variables
10. **Tech Industry Trend Line**: Added purple dotted trend line for tech companies in charts
11. **Y-Axis Label Updates**: Changed from "Rolling Average" to "4Q" to reflect 4-quarter calculations
12. **Enhanced Chart Features**: Market trend line (blue dashed) and tech trend line (purple dotted)

CONTROL VARIABLES INCLUDED:
==========================

The regression model includes 18 control variables:
...
6. **profitability**: Gross Profit / Total Assets
7. **ppe_total_assets**: ΔPPE / Total Assets
8. **rnd_intensity**: R&D Expense / Revenue
9. **acquisitions_intensity**: |Acquisitions Net| / Total Assets
10. **goodwill_change_intensity**: |ΔGoodwill| / Intangible Assets
11. **intangible_assets_change_intensity**: ΔIntangible Assets / Total Assets
12. **total_dna**: Depreciation & Amortization / Total Assets
13. **log_market_cap**: ln(Market Capitalization)
14. **log_total_assets**: ln(Total Assets)
15. **earnings_quality**: Operating Cash Flow / Net Income
16. **quarter_number**: Fiscal quarter (1-4)
17. **year**: Calendar year
18. **Industry Fixed Effects**: Sector dummy variables
...
5. Generate scatter plots showing relationships between:
   ...
   - Includes Market Trend Line (blue dashed) and Tech Industry Trend Line (purple dotted)
