...
def main():
    ...
    if X_clean.empty or y_clean.empty:
        ...
        plt.tight_layout()
        robust_savefig("rnd_to_btd_vs_ocf_margin_v1.png", dpi=300, bbox_inches='tight')
        plt.close()
    else:
    ...
    output_filename = "s174_tcja_ocf_output.csv"
    ...
    if time_series_metrics:
        ...
        ts_filename = "s174_tcja_ocf_time_series.csv"
    ...
    diagnostic_filename = "s174_tcja_ocf_diagnostics.csv"
    ...
    if chart_selection['should_generate_chart']:
        ...
        chart_filename = f"s174_tcja_ocf_chart.png"
