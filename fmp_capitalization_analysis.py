...
def main():
    ...
    # Set Software as the baseline (reference category)
    ...
    if len(fe_coefficients) > 0:
        print("Industry Fixed Effects (relative to Software baseline):")
        for industry, coef in fe_coefficients.items():
            industry_name = industry.replace('C(sector_baseline, Treatment(reference="Software"))[', '').replace(']', '')
            print(f"  {industry_name}: {coef:.6f}")
        print("  Software: 0.000000 (baseline/reference category)")
    else:
    ...
    if X_clean.empty or y_clean.empty:
        ...
        plt.tight_layout()
        robust_savefig("cap_intensity_vs_ocf_margin.png", dpi=300, bbox_inches='tight')
        plt.close()
        plt.figure(figsize=(12, 8))
        plt.title("No data available for regression chart", fontsize=16)
        plt.text(0.5, 0.5, "No data available", fontsize=16, color='gray', ha='center', va='center', transform=plt.gca().transAxes)
        plt.tight_layout()
        robust_savefig("rnd_deferral_vs_ocf_margin.png", dpi=300, bbox_inches='tight')
        plt.close()
    else:
    ...
    output_filename = "capitalization_analysis_output.csv"
    ...
    plot_regression_chart(
        ...
        chart_filename='rnd_deferral_vs_ocf_margin.png',
    ...
    print("[DIAGNOSTIC] rnd_deferral_vs_ocf_margin.png exported.")
    ...
    plot_regression_chart(
        ...
        x_col='cap_intensity',
        y_col='ocf_margin_next',
        chart_filename='cap_intensity_vs_ocf_margin.png',
    ...
    print("[DIAGNOSTIC] cap_intensity_vs_ocf_margin.png exported.")
